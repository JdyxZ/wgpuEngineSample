...
shared_ptr<Transform> Raytracing::Transform::inverse()
{
...
shared_ptr<Matrix44> Raytracing::Transform::get_model()
{
	if (!recompute)
		return model;
...
shared_ptr<Matrix44> Raytracing::Transform::compute_model()
{
...
const shared_ptr<Matrix44> Raytracing::Transform::transform_matrix(const vec3& translation, vec3 axis, const double& angle, const vec3& scailing)
{
